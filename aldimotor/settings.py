"""
Django settings for aldimotor project.
...
SECRET_KEY = 'django-insecure-s@6b5z6-@&0**47k)!e!m%a*io3qrex!%w6)q93uipx8g0#b7s'
...
WSGI_APPLICATION = 'aldimotor.wsgi.application'
