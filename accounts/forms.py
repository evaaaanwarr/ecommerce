...
class SignUpForm(UserCreationForm):
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'phone_number', 'email', 'birth_date')
...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'placeholder': 'Masukan First Name', 'class': 'form-control'}),
            'last_name': forms.TextInput(attrs={'placeholder': 'Masukan Last Name', 'class': 'form-control'}),
            'email': forms.TextInput(attrs={'placeholder': 'Masukan Email', 'class': 'form-control'}),
            'phone_number': forms.TextInput(attrs={'placeholder': '+62813xxx', 'class': 'form-control'}),
        }
